...
> Benchmark code snippets and compare

[![PyPI version](https://badge.fury.io/py/py-benchmark.svg)](https://pypi.org/project/py-benchmark/)
...
# Basic usage
result = benchmark("your input here")
print(result)
```
...
result = benchmark("Hello World")

# Example 2: Batch processing
from py_benchmark import batch
